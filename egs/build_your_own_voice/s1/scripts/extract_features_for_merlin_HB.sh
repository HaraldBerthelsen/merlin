...
merlin_dir="/home/harald/git/hb_merlin"
...
wav_dir="${merlin_dir}/egs/build_your_own_voice/s1/database/wav"

# Output features directory
out_dir="${merlin_dir}/egs/build_your_own_voice/s1/database/feat"
