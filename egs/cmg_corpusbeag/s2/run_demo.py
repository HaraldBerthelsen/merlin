...
@author: Felipe Espic, Harald Berthelsen
"""
...
if __name__ == '__main__':
    ...
    # Steps:---------------------------------------------------------------------------------
    #HB b_download_data  = 1 # Downloads wavs and label data.
    b_copy_data  = 0 # Copies wavs and label data.
    ...
    # PROCESS:===================================================================================================
    # Pre setup:-------------------------------------------------------------------------------
    dataset = "cmg_corpusbeag"
    exper_name  = '%s_magphase_%s_mag_dim_%s_phase_dim_%d_const_rate_%d' % (dataset, exper_type, d_mp_opts['mag_dim'], d_mp_opts['phase_dim'], d_mp_opts['b_const_rate'])
    ...
    # Link Data:--------------------------------------------------------------------------
    if b_copy_data:
        #data_dir = join(this_dir, '%s_magphase_%s_data' % (dataset, exper_type))
        call(['./copy_data.sh'])
        #call(['unzip', '-o', '-q', data_zip_file, '-d', this_dir])
