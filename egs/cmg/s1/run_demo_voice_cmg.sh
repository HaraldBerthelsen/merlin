...
if [ "$setup_data" = true ]; then
    ...
    cp ~/svn/Corpora/ga_MU/cmg/CMGCorpusBeag/wav16_trimmed/*.wav database/wav/
    cp ~/svn/Corpora/ga_MU/cmg/CMGCorpusBeag/merlin_lab/*.lab database/labels/label_phone_align/

    cp ~/svn/Corpora/ga_MU/cmg/CMGOther/wav16_trimmed/*.wav database/wav/
    cp ~/svn/Corpora/ga_MU/cmg/CMGOther/merlin_lab/*.lab database/labels/label_phone_align/
fi
