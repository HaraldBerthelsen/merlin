...
# Basic Theano flags
#HB MERLIN_THEANO_FLAGS="cuda.root=/usr/local/cuda-8.0,floatX=float32,on_unused_input=ignore"
MERLIN_THEANO_FLAGS="cuda.root=/usr/local/cuda-9.0,floatX=float32,on_unused_input=ignore"
